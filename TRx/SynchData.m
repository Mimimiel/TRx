...
//    UIImage *image;
//    
//    NSString *text = [LocalTalk localGetOper];
//    NSData *data = [Base64 decode:text];
//    image = [UIImage imageWithData:data];
//
//    
//    
//    Patient *newPatient = [[Patient alloc] initWithPatientId:patientId currentRecordId:recordId patientRecordAppId:PatientRecordAppId firstName:fName MiddleName:mName LastName:lName birthday:bDay ChiefComplaint:chiefComplaint PhotoID:image];
//    
//    return newPatient;
//}
