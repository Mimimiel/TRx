...
-(void)testMidnight {
    ...
    //add patient
//    INSERT INTO Patient (rowId, Id, AppId, FirstName, MiddleName, LastName, Birthday, Created, LastModified, LastSynced)
//    VALUES 		      (1,	1, 	1,	John, 	Thomas, 		Cotham	, "20040101", 32838, 39389, 	33822)
//    INSERT INTO Patient (rowId, Id, AppId, FirstName, MiddleName, LastName, Birthday, Created, LastModified, LastSynced)
//    VALUES 		      (1,	1, 	1,	"John", 	"Thomas", 		"Cotham"	, "20040101", 32838, 39389, 	33822);
